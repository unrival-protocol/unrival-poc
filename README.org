...
* Introduction
Unrival is a protocol for directing collective intelligence towards the accomplishment of arbitrary goals.
...
*** Agent
*** Goal
A /goal/ is an outcome that can be subscribed to/desired by one or more agents.  Strictly speaking, goals are not a necessary part of the protocol - they simply act as psychological markers for motivating and organizing Unrival activities.
